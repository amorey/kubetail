...
func NewWebTestClient(t *testing.T, app AppInterface) *WebTestClient {
	...
	// Add wraponce middleware
	app.Use(func(c *gin.Context) {
		if client.wraponce != nil {
			defer func() { client.wraponce = nil }()
			client.wraponce(c)
		} else {
			c.Next()
		}
...
func NewWebTestClientWithoutCookieJar(t *testing.T, app *gin.Engine) *WebTestClient {
