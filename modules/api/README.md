...
Go-based HTTP server that handles Kubetail API requests

## Configure

### CLI Flags

The Kubetail API executable supports the following command line configuration options:
