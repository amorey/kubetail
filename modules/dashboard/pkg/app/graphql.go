...
func (a *graphQLHandlers) EndpointHandler(allowedNamespaces []string, csrfProtectMiddleware func(http.Handler) http.Handler) gin.HandlerFunc {
	// Init resolver
	r, err := graph.NewResolver(allowedNamespaces)
	if err != nil {
...
// Return pointer to new handlers instance
func newGraphQLHandlers(app *app) *graphQLHandlers {
	return &graphQLHandlers{app}
}
